...
<div className="rightbox">
        ...
        <img
          ...
          src="./images/workshop_img (1).jpeg"
          alt="img1"
          className="img-fluid workshop_img "
          srcset=""
          id="author_img"
        />
        <h3>Work Space</h3>
        ...
        <p className="authorwork">
          ...
          inonsectetur adipisicing elit. Quaerat amet veniam, assumenda guena iner
